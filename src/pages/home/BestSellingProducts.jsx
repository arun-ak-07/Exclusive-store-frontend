...
const BestSellingProducts = () => {
  ...
  return (
    <div className="w-full mt-10 h-full md:p-36">
  ...
  <h1 className="font-bold text-4xl text-center md:text-left">Best Selling Products</h1>
  <button className="bg-red-600 text-xs p-4 px-16 text-white rounded-sm font-semibold">
    View All
        ...
        {products?.slice(4, 8).map((prod, ind) => (
  <div
    key={ind}
